  ...
  return (
    <>
      <div className="px-2 pt-4 pb-4 flex flex-col">
        ...
        <div className="font-light tracking-wide ml-8 -mt-2 hover:bg-gray-700 rounded-lg p-1 transition-colors break-all">
          <Tooltip id="link-id" />
          <ReactMarkdown
            components={{
              ul: ({ children }) => (
              ...
              thead: (props) => (
                <thead className="bg-gray-800" {...props}></thead>
              ),
              tbody: (props) => (
                <tbody className="bg-gray-700" {...props}></tbody>
              ),
              tr: (props) => (
                <tr className="border-b border-gray-600" {...props}></tr>
              ),
