...
export default function MediaPick({
  ...
  return (
    <div className={`${isMobile ? 'h-[250px]' : ''} flex flex-col ml-5 `}>
      ...
      <div className="w-12 h-auto flex flex-col mx-auto mt-2 items-center overflow-y-scroll">
        <div className={`flex flex-col ${modalStyle.mediaSelect} mb-4`}>
          <button
            ...
            className="text-lg bg-frost-500 rounded-t-lg"
          >
            Set Input Devices
          </button>
          <div
            className={`${
              inputVisible ? 'hidden' : 'visible'
            } flex flex-col items-center border-frost-500 border rounded-b-lg`}
          >
            <span className="underline font-bold text-base mb-2 tracking-wide">
              Audio input Devices
            </span>
            <MediaDeviceSelect
        ...
        <div className={`flex flex-col ${modalStyle.mediaSelect}`}>
          <button
            onClick={() => {
              outputVisible ? setOutputVisible(false) : setOutputVisible(true);
            }}
            className="text-lg bg-frost-500 rounded-t-lg"
          >
            Set Output Device
