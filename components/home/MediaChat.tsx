import { useChannel, useCurrentRoomRef, useSetConnectionState, useSetCurrentRoom, useSetToken, useUserRef} from '@/lib/store';
...
export default function MediaChat() {
  ...
  const setRoomRef = useSetCurrentRoom();
      ...
      {currentRoom !== channel?.channel_id  && connectionState === ConnectionState.Connected ? (
        <>
          ...
          <div className={'h-full relative'}>
            <div className={'bg-grey-800 h-full w-full flex items-center justify-center'}>
              <div className={`h-11 w-13 bg-grey-500 rounded-lg ${mediaStyle.mediaError} border-2 opacity-70 flex flex-col items-center justify-center`}>
